import { moduleClass, moduleInterface } from "../moduleClass";
import {
  dayOfYear,
  currentDayOfYear,
...
class formModule extends moduleClass implements moduleInterface{
    ...
    public async formModule() {
        return this;
    }
    public async create(patient: string, mainDoctor: string) {
        this.module(this.modCT, patient, mainDoctor);

        
        return "";
    }
    
    public async add_question(question: string, answer: any) {
